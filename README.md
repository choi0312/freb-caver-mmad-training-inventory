...
> 이 저장소는 비공개 연구 자료 저장소입니다. 전체 묶음은 [Release v1.0](https://github.com/choi0312/freb-caver-mmad-training-inventory/releases/tag/v1.0)에서 `FREB_CAVER_MMAD_training_bundle.zip`으로 다운로드할 수 있습니다.
